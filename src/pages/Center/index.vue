        ...
        <div class="order-right">
          <div class="order-content">
            ...
            <div class="choose-order">
              <!-- 分页器 -->
              <Pagination :pageNo="page" :pageSize="3" :total="MyOrder.total" :continues="5" @getPageNo="getPageNo"></Pagination>
            </div>
          </div>
          <!--猜你喜欢-->
          <div class="like">
...
export default {
  ...
  methods: {
    ...
    async getData() {
      // 发起请求
      const res = await this.$API.reqMyOrder(this.page, this.limit)
      // 判断
      if (res.code === 200) {
