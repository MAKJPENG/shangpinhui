  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="(address) in addressInfo" :key="address.id">
        ...
        <p @click="changIsDefault(address)">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{defAddress.userAddress}}</span>
        收货人：<span>{{defAddress.consignee}}</span>
        <span>{{defAddress.phoneNum}}</span>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...
    // 选择的收货地址
    defAddress() {
      return this.addressInfo.filter((address) => {
  ...
  methods: {
    // 实现地址选择
    changIsDefault(address, addressInfo) {
      // 排他
    ...
    async submitOrder() {
      ...
      const data = {
        "consignee": this.defAddress.consignee,
        "consigneeTel": this.defAddress.phoneNum,
        "deliveryAddress": this.defAddress.userAddress,
        "paymentWay": "ONLINE",
